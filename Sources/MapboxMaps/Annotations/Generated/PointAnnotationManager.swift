...
public class PointAnnotationManager: AnnotationManagerInternal {
    ...
    internal func destroy() {
        ...
        do {
            ...
            Log.warning(
                forMessage: "Failed to remove layer for \(type(of: self)) with id \(id) due to error: \(error)",
                category: "Annotations")
        }
        do {
            ...
            Log.warning(
                forMessage: "Failed to remove source for \(type(of: self)) with id \(id) due to error: \(error)",
                category: "Annotations")
        }
